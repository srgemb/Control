...
//Идентификаторы устройств в сети подключенных по протоколу MODBUS
#define MB_ID_DEV_TRACKER   0x01        //солнечный трекер
#define MB_ID_DEV_VOICE     0x02        //голосовой информатор
#define MB_ID_DEV_METEO     0x03        //метео станция
#define MB_ID_DEV_GEN       0x04        //контроллер генератора
#define MB_ID_DEV_4         0x05        //резерв
